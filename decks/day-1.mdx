...
<Head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/tailwindcss/dist/tailwind.min.css" rel="stylesheet" crossOrigin="anonymous" />
...
<i className="mt-10 em em-wave"></i>
...
- <div className="italic">
    ...
    &amp; <span className="text-green">npm</span> installed
  </div>
...
<h2 className="mb-10">
  <div className="font-black text-orange-dark">
    Day 1: <span className="text-green">ReactJS Foundations</span>
  </div>
  <div className="text-grey-darkest text-3xl mt-4">
...
<h2 className="mb-10">
  <div className="font-black text-orange-dark">
    Day 2: <span className="text-green">Advanced ReactJS</span>
  </div>
  <div className="text-grey-darkest text-3xl mt-4">
...
<h2>
  <div className="font-black text-orange-dark">
    Day 3: <span className="text-green">Redux</span>
  </div>
  <div className="text-grey-darkest text-3xl mt-4">
    State management & (async) side effect management
  </div>
</h2>
...
<img src={exampleAppImg} width="75%" alt="SPA app that will built during the workshop" />
...
<div className="text-5xl mt-5 em em-face_vomiting" />
